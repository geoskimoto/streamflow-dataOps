...
def test_smart_append_multiple_stations(test_db):
    ...
    date1 = smart_append.get_pull_start_date(
        config.id, "01234567", config.pull_start_date
    )
    date2 = smart_append.get_pull_start_date(
        config.id, "12345678", config.pull_start_date
    )
    date3 = smart_append.get_pull_start_date(
        config.id, "23456789", config.pull_start_date
    )
