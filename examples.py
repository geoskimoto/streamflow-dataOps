...
def example_basic_usage():
    ...
    try:
        ...
        print(
            f"✓ Latest observation: {latest.discharge} {latest.unit} at {latest.observed_at}"
        )
...
def example_pull_configuration():
    ...
    try:
        ...
        print(
            f"✓ Updated progress for station 14211720: last pull {progress1.last_successful_pull_date}"
        )
